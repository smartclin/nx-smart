...
export const BillingFindManySelectSchema: z.ZodType<Prisma.BillingSelect> = z.object({
...
export const BillingFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    patientId: z.boolean().optional(),
    patient: z.boolean().optional(),
    appointmentId: z.boolean().optional(),
...
export const BillingFindManySchema: z.ZodType<Prisma.BillingFindManyArgs> = z.object({ select: BillingFindManySelectSchema.optional(), include: z.lazy(() => BillingIncludeObjectSchema.optional()), orderBy: z.union([BillingOrderByWithRelationInputObjectSchema, BillingOrderByWithRelationInputObjectSchema.array()]).optional(), where: BillingWhereInputObjectSchema.optional(), cursor: BillingWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([BillingScalarFieldEnumSchema, BillingScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.BillingFindManyArgs>;

export const BillingFindManyZodSchema = z.object({ select: BillingFindManySelectSchema.optional(), include: z.lazy(() => BillingIncludeObjectSchema.optional()), orderBy: z.union([BillingOrderByWithRelationInputObjectSchema, BillingOrderByWithRelationInputObjectSchema.array()]).optional(), where: BillingWhereInputObjectSchema.optional(), cursor: BillingWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([BillingScalarFieldEnumSchema, BillingScalarFieldEnumSchema.array()]).optional() }).strict();