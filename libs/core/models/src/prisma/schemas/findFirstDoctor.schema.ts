...
export const DoctorFindFirstSelectSchema: z.ZodType<Prisma.DoctorSelect> = z.object({
...
export const DoctorFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    email: z.boolean().optional(),
    name: z.boolean().optional(),
    userId: z.boolean().optional(),
...
export const DoctorFindFirstSchema: z.ZodType<Prisma.DoctorFindFirstArgs> = z.object({ select: DoctorFindFirstSelectSchema.optional(), include: z.lazy(() => DoctorIncludeObjectSchema.optional()), orderBy: z.union([DoctorOrderByWithRelationInputObjectSchema, DoctorOrderByWithRelationInputObjectSchema.array()]).optional(), where: DoctorWhereInputObjectSchema.optional(), cursor: DoctorWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DoctorScalarFieldEnumSchema, DoctorScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.DoctorFindFirstArgs>;

export const DoctorFindFirstZodSchema = z.object({ select: DoctorFindFirstSelectSchema.optional(), include: z.lazy(() => DoctorIncludeObjectSchema.optional()), orderBy: z.union([DoctorOrderByWithRelationInputObjectSchema, DoctorOrderByWithRelationInputObjectSchema.array()]).optional(), where: DoctorWhereInputObjectSchema.optional(), cursor: DoctorWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DoctorScalarFieldEnumSchema, DoctorScalarFieldEnumSchema.array()]).optional() }).strict();