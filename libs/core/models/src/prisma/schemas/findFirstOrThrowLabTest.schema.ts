...
export const LabTestFindFirstOrThrowSelectSchema: z.ZodType<Prisma.LabTestSelect> = z.object({
...
export const LabTestFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    recordId: z.boolean().optional(),
    testDate: z.boolean().optional(),
    result: z.boolean().optional(),
...
export const LabTestFindFirstOrThrowSchema: z.ZodType<Prisma.LabTestFindFirstOrThrowArgs> = z.object({ select: LabTestFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => LabTestIncludeObjectSchema.optional()), orderBy: z.union([LabTestOrderByWithRelationInputObjectSchema, LabTestOrderByWithRelationInputObjectSchema.array()]).optional(), where: LabTestWhereInputObjectSchema.optional(), cursor: LabTestWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([LabTestScalarFieldEnumSchema, LabTestScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.LabTestFindFirstOrThrowArgs>;

export const LabTestFindFirstOrThrowZodSchema = z.object({ select: LabTestFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => LabTestIncludeObjectSchema.optional()), orderBy: z.union([LabTestOrderByWithRelationInputObjectSchema, LabTestOrderByWithRelationInputObjectSchema.array()]).optional(), where: LabTestWhereInputObjectSchema.optional(), cursor: LabTestWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([LabTestScalarFieldEnumSchema, LabTestScalarFieldEnumSchema.array()]).optional() }).strict();