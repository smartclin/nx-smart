...
export const WHOGrowthStandardFindManySelectSchema: z.ZodType<Prisma.WHOGrowthStandardSelect> = z.object({
...
export const WHOGrowthStandardFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    ageInMonths: z.boolean().optional(),
    gender: z.boolean().optional(),
    measurementType: z.boolean().optional(),
...
export const WHOGrowthStandardFindManySchema: z.ZodType<Prisma.WHOGrowthStandardFindManyArgs> = z.object({ select: WHOGrowthStandardFindManySelectSchema.optional(),  orderBy: z.union([WHOGrowthStandardOrderByWithRelationInputObjectSchema, WHOGrowthStandardOrderByWithRelationInputObjectSchema.array()]).optional(), where: WHOGrowthStandardWhereInputObjectSchema.optional(), cursor: WHOGrowthStandardWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([WHOGrowthStandardScalarFieldEnumSchema, WHOGrowthStandardScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.WHOGrowthStandardFindManyArgs>;

export const WHOGrowthStandardFindManyZodSchema = z.object({ select: WHOGrowthStandardFindManySelectSchema.optional(),  orderBy: z.union([WHOGrowthStandardOrderByWithRelationInputObjectSchema, WHOGrowthStandardOrderByWithRelationInputObjectSchema.array()]).optional(), where: WHOGrowthStandardWhereInputObjectSchema.optional(), cursor: WHOGrowthStandardWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([WHOGrowthStandardScalarFieldEnumSchema, WHOGrowthStandardScalarFieldEnumSchema.array()]).optional() }).strict();