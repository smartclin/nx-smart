...
export const ServicesFindManySelectSchema: z.ZodType<Prisma.ServicesSelect> = z.object({
...
export const ServicesFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    serviceName: z.boolean().optional(),
    description: z.boolean().optional(),
    price: z.boolean().optional(),
...
export const ServicesFindManySchema: z.ZodType<Prisma.ServicesFindManyArgs> = z.object({ select: ServicesFindManySelectSchema.optional(), include: z.lazy(() => ServicesIncludeObjectSchema.optional()), orderBy: z.union([ServicesOrderByWithRelationInputObjectSchema, ServicesOrderByWithRelationInputObjectSchema.array()]).optional(), where: ServicesWhereInputObjectSchema.optional(), cursor: ServicesWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ServicesScalarFieldEnumSchema, ServicesScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ServicesFindManyArgs>;

export const ServicesFindManyZodSchema = z.object({ select: ServicesFindManySelectSchema.optional(), include: z.lazy(() => ServicesIncludeObjectSchema.optional()), orderBy: z.union([ServicesOrderByWithRelationInputObjectSchema, ServicesOrderByWithRelationInputObjectSchema.array()]).optional(), where: ServicesWhereInputObjectSchema.optional(), cursor: ServicesWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ServicesScalarFieldEnumSchema, ServicesScalarFieldEnumSchema.array()]).optional() }).strict();