...
export const GrowthChartFindFirstOrThrowSelectSchema: z.ZodType<Prisma.GrowthChartSelect> = z.object({
...
export const GrowthChartFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    patientId: z.boolean().optional(),
    gender: z.boolean().optional(),
    patient: z.boolean().optional(),
...
export const GrowthChartFindFirstOrThrowSchema: z.ZodType<Prisma.GrowthChartFindFirstOrThrowArgs> = z.object({ select: GrowthChartFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => GrowthChartIncludeObjectSchema.optional()), orderBy: z.union([GrowthChartOrderByWithRelationInputObjectSchema, GrowthChartOrderByWithRelationInputObjectSchema.array()]).optional(), where: GrowthChartWhereInputObjectSchema.optional(), cursor: GrowthChartWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([GrowthChartScalarFieldEnumSchema, GrowthChartScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.GrowthChartFindFirstOrThrowArgs>;

export const GrowthChartFindFirstOrThrowZodSchema = z.object({ select: GrowthChartFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => GrowthChartIncludeObjectSchema.optional()), orderBy: z.union([GrowthChartOrderByWithRelationInputObjectSchema, GrowthChartOrderByWithRelationInputObjectSchema.array()]).optional(), where: GrowthChartWhereInputObjectSchema.optional(), cursor: GrowthChartWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([GrowthChartScalarFieldEnumSchema, GrowthChartScalarFieldEnumSchema.array()]).optional() }).strict();