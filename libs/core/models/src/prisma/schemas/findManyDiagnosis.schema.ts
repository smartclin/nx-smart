...
export const DiagnosisFindManySelectSchema: z.ZodType<Prisma.DiagnosisSelect> = z.object({
...
export const DiagnosisFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    patientId: z.boolean().optional(),
    medicalId: z.boolean().optional(),
    doctorId: z.boolean().optional(),
...
export const DiagnosisFindManySchema: z.ZodType<Prisma.DiagnosisFindManyArgs> = z.object({ select: DiagnosisFindManySelectSchema.optional(), include: z.lazy(() => DiagnosisIncludeObjectSchema.optional()), orderBy: z.union([DiagnosisOrderByWithRelationInputObjectSchema, DiagnosisOrderByWithRelationInputObjectSchema.array()]).optional(), where: DiagnosisWhereInputObjectSchema.optional(), cursor: DiagnosisWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DiagnosisScalarFieldEnumSchema, DiagnosisScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.DiagnosisFindManyArgs>;

export const DiagnosisFindManyZodSchema = z.object({ select: DiagnosisFindManySelectSchema.optional(), include: z.lazy(() => DiagnosisIncludeObjectSchema.optional()), orderBy: z.union([DiagnosisOrderByWithRelationInputObjectSchema, DiagnosisOrderByWithRelationInputObjectSchema.array()]).optional(), where: DiagnosisWhereInputObjectSchema.optional(), cursor: DiagnosisWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DiagnosisScalarFieldEnumSchema, DiagnosisScalarFieldEnumSchema.array()]).optional() }).strict();