...
export const VitalSignsFindFirstOrThrowSelectSchema: z.ZodType<Prisma.VitalSignsSelect> = z.object({
...
export const VitalSignsFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    encounterId: z.boolean().optional(),
    encounter: z.boolean().optional(),
    patientId: z.boolean().optional(),
...
export const VitalSignsFindFirstOrThrowSchema: z.ZodType<Prisma.VitalSignsFindFirstOrThrowArgs> = z.object({ select: VitalSignsFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => VitalSignsIncludeObjectSchema.optional()), orderBy: z.union([VitalSignsOrderByWithRelationInputObjectSchema, VitalSignsOrderByWithRelationInputObjectSchema.array()]).optional(), where: VitalSignsWhereInputObjectSchema.optional(), cursor: VitalSignsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([VitalSignsScalarFieldEnumSchema, VitalSignsScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.VitalSignsFindFirstOrThrowArgs>;

export const VitalSignsFindFirstOrThrowZodSchema = z.object({ select: VitalSignsFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => VitalSignsIncludeObjectSchema.optional()), orderBy: z.union([VitalSignsOrderByWithRelationInputObjectSchema, VitalSignsOrderByWithRelationInputObjectSchema.array()]).optional(), where: VitalSignsWhereInputObjectSchema.optional(), cursor: VitalSignsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([VitalSignsScalarFieldEnumSchema, VitalSignsScalarFieldEnumSchema.array()]).optional() }).strict();