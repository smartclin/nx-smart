...
export const MedicalRecordsFindFirstOrThrowSelectSchema: z.ZodType<Prisma.MedicalRecordsSelect> = z.object({
...
export const MedicalRecordsFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    patientId: z.boolean().optional(),
    appointmentId: z.boolean().optional(),
    doctorId: z.boolean().optional(),
...
export const MedicalRecordsFindFirstOrThrowSchema: z.ZodType<Prisma.MedicalRecordsFindFirstOrThrowArgs> = z.object({ select: MedicalRecordsFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => MedicalRecordsIncludeObjectSchema.optional()), orderBy: z.union([MedicalRecordsOrderByWithRelationInputObjectSchema, MedicalRecordsOrderByWithRelationInputObjectSchema.array()]).optional(), where: MedicalRecordsWhereInputObjectSchema.optional(), cursor: MedicalRecordsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([MedicalRecordsScalarFieldEnumSchema, MedicalRecordsScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.MedicalRecordsFindFirstOrThrowArgs>;

export const MedicalRecordsFindFirstOrThrowZodSchema = z.object({ select: MedicalRecordsFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => MedicalRecordsIncludeObjectSchema.optional()), orderBy: z.union([MedicalRecordsOrderByWithRelationInputObjectSchema, MedicalRecordsOrderByWithRelationInputObjectSchema.array()]).optional(), where: MedicalRecordsWhereInputObjectSchema.optional(), cursor: MedicalRecordsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([MedicalRecordsScalarFieldEnumSchema, MedicalRecordsScalarFieldEnumSchema.array()]).optional() }).strict();