...
export const AppointmentFindFirstSelectSchema: z.ZodType<Prisma.AppointmentSelect> = z.object({
...
export const AppointmentFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    patientId: z.boolean().optional(),
    doctorId: z.boolean().optional(),
    serviceId: z.boolean().optional(),
