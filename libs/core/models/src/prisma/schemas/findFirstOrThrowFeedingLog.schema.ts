...
export const FeedingLogFindFirstOrThrowSelectSchema: z.ZodType<Prisma.FeedingLogSelect> = z.object({
...
export const FeedingLogFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    patientId: z.boolean().optional(),
    patient: z.boolean().optional(),
    date: z.boolean().optional(),
...
export const FeedingLogFindFirstOrThrowSchema: z.ZodType<Prisma.FeedingLogFindFirstOrThrowArgs> = z.object({ select: FeedingLogFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => FeedingLogIncludeObjectSchema.optional()), orderBy: z.union([FeedingLogOrderByWithRelationInputObjectSchema, FeedingLogOrderByWithRelationInputObjectSchema.array()]).optional(), where: FeedingLogWhereInputObjectSchema.optional(), cursor: FeedingLogWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([FeedingLogScalarFieldEnumSchema, FeedingLogScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.FeedingLogFindFirstOrThrowArgs>;

export const FeedingLogFindFirstOrThrowZodSchema = z.object({ select: FeedingLogFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => FeedingLogIncludeObjectSchema.optional()), orderBy: z.union([FeedingLogOrderByWithRelationInputObjectSchema, FeedingLogOrderByWithRelationInputObjectSchema.array()]).optional(), where: FeedingLogWhereInputObjectSchema.optional(), cursor: FeedingLogWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([FeedingLogScalarFieldEnumSchema, FeedingLogScalarFieldEnumSchema.array()]).optional() }).strict();