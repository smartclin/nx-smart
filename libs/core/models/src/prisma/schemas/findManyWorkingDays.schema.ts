...
export const WorkingDaysFindManySelectSchema: z.ZodType<Prisma.WorkingDaysSelect> = z.object({
...
export const WorkingDaysFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    doctorId: z.boolean().optional(),
    day: z.boolean().optional(),
    startTime: z.boolean().optional(),
...
export const WorkingDaysFindManySchema: z.ZodType<Prisma.WorkingDaysFindManyArgs> = z.object({ select: WorkingDaysFindManySelectSchema.optional(), include: z.lazy(() => WorkingDaysIncludeObjectSchema.optional()), orderBy: z.union([WorkingDaysOrderByWithRelationInputObjectSchema, WorkingDaysOrderByWithRelationInputObjectSchema.array()]).optional(), where: WorkingDaysWhereInputObjectSchema.optional(), cursor: WorkingDaysWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([WorkingDaysScalarFieldEnumSchema, WorkingDaysScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.WorkingDaysFindManyArgs>;

export const WorkingDaysFindManyZodSchema = z.object({ select: WorkingDaysFindManySelectSchema.optional(), include: z.lazy(() => WorkingDaysIncludeObjectSchema.optional()), orderBy: z.union([WorkingDaysOrderByWithRelationInputObjectSchema, WorkingDaysOrderByWithRelationInputObjectSchema.array()]).optional(), where: WorkingDaysWhereInputObjectSchema.optional(), cursor: WorkingDaysWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([WorkingDaysScalarFieldEnumSchema, WorkingDaysScalarFieldEnumSchema.array()]).optional() }).strict();