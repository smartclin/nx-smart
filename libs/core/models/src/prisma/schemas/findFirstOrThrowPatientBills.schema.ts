...
export const PatientBillsFindFirstOrThrowSelectSchema: z.ZodType<Prisma.PatientBillsSelect> = z.object({
...
export const PatientBillsFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    billId: z.boolean().optional(),
    serviceId: z.boolean().optional(),
    serviceDate: z.boolean().optional(),
...
export const PatientBillsFindFirstOrThrowSchema: z.ZodType<Prisma.PatientBillsFindFirstOrThrowArgs> = z.object({ select: PatientBillsFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => PatientBillsIncludeObjectSchema.optional()), orderBy: z.union([PatientBillsOrderByWithRelationInputObjectSchema, PatientBillsOrderByWithRelationInputObjectSchema.array()]).optional(), where: PatientBillsWhereInputObjectSchema.optional(), cursor: PatientBillsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PatientBillsScalarFieldEnumSchema, PatientBillsScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.PatientBillsFindFirstOrThrowArgs>;

export const PatientBillsFindFirstOrThrowZodSchema = z.object({ select: PatientBillsFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => PatientBillsIncludeObjectSchema.optional()), orderBy: z.union([PatientBillsOrderByWithRelationInputObjectSchema, PatientBillsOrderByWithRelationInputObjectSchema.array()]).optional(), where: PatientBillsWhereInputObjectSchema.optional(), cursor: PatientBillsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PatientBillsScalarFieldEnumSchema, PatientBillsScalarFieldEnumSchema.array()]).optional() }).strict();