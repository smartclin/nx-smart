...
export const PrescriptionFindFirstOrThrowSelectSchema: z.ZodType<Prisma.PrescriptionSelect> = z.object({
...
export const PrescriptionFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    medicalRecordId: z.boolean().optional(),
    doctorId: z.boolean().optional(),
    patientId: z.boolean().optional(),
...
export const PrescriptionFindFirstOrThrowSchema: z.ZodType<Prisma.PrescriptionFindFirstOrThrowArgs> = z.object({ select: PrescriptionFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => PrescriptionIncludeObjectSchema.optional()), orderBy: z.union([PrescriptionOrderByWithRelationInputObjectSchema, PrescriptionOrderByWithRelationInputObjectSchema.array()]).optional(), where: PrescriptionWhereInputObjectSchema.optional(), cursor: PrescriptionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PrescriptionScalarFieldEnumSchema, PrescriptionScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.PrescriptionFindFirstOrThrowArgs>;

export const PrescriptionFindFirstOrThrowZodSchema = z.object({ select: PrescriptionFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => PrescriptionIncludeObjectSchema.optional()), orderBy: z.union([PrescriptionOrderByWithRelationInputObjectSchema, PrescriptionOrderByWithRelationInputObjectSchema.array()]).optional(), where: PrescriptionWhereInputObjectSchema.optional(), cursor: PrescriptionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PrescriptionScalarFieldEnumSchema, PrescriptionScalarFieldEnumSchema.array()]).optional() }).strict();