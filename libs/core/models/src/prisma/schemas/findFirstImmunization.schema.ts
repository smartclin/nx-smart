...
export const ImmunizationFindFirstSelectSchema: z.ZodType<Prisma.ImmunizationSelect> = z.object({
...
export const ImmunizationFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    patientId: z.boolean().optional(),
    patient: z.boolean().optional(),
    vaccine: z.boolean().optional(),
...
export const ImmunizationFindFirstSchema: z.ZodType<Prisma.ImmunizationFindFirstArgs> = z.object({ select: ImmunizationFindFirstSelectSchema.optional(), include: z.lazy(() => ImmunizationIncludeObjectSchema.optional()), orderBy: z.union([ImmunizationOrderByWithRelationInputObjectSchema, ImmunizationOrderByWithRelationInputObjectSchema.array()]).optional(), where: ImmunizationWhereInputObjectSchema.optional(), cursor: ImmunizationWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ImmunizationScalarFieldEnumSchema, ImmunizationScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ImmunizationFindFirstArgs>;

export const ImmunizationFindFirstZodSchema = z.object({ select: ImmunizationFindFirstSelectSchema.optional(), include: z.lazy(() => ImmunizationIncludeObjectSchema.optional()), orderBy: z.union([ImmunizationOrderByWithRelationInputObjectSchema, ImmunizationOrderByWithRelationInputObjectSchema.array()]).optional(), where: ImmunizationWhereInputObjectSchema.optional(), cursor: ImmunizationWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ImmunizationScalarFieldEnumSchema, ImmunizationScalarFieldEnumSchema.array()]).optional() }).strict();