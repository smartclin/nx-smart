...
export const WorkingDaysFindFirstSelectSchema: z.ZodType<Prisma.WorkingDaysSelect> = z.object({
...
export const WorkingDaysFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    doctorId: z.boolean().optional(),
    day: z.boolean().optional(),
    startTime: z.boolean().optional(),
...
export const WorkingDaysFindFirstSchema: z.ZodType<Prisma.WorkingDaysFindFirstArgs> = z.object({ select: WorkingDaysFindFirstSelectSchema.optional(), include: z.lazy(() => WorkingDaysIncludeObjectSchema.optional()), orderBy: z.union([WorkingDaysOrderByWithRelationInputObjectSchema, WorkingDaysOrderByWithRelationInputObjectSchema.array()]).optional(), where: WorkingDaysWhereInputObjectSchema.optional(), cursor: WorkingDaysWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([WorkingDaysScalarFieldEnumSchema, WorkingDaysScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.WorkingDaysFindFirstArgs>;

export const WorkingDaysFindFirstZodSchema = z.object({ select: WorkingDaysFindFirstSelectSchema.optional(), include: z.lazy(() => WorkingDaysIncludeObjectSchema.optional()), orderBy: z.union([WorkingDaysOrderByWithRelationInputObjectSchema, WorkingDaysOrderByWithRelationInputObjectSchema.array()]).optional(), where: WorkingDaysWhereInputObjectSchema.optional(), cursor: WorkingDaysWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([WorkingDaysScalarFieldEnumSchema, WorkingDaysScalarFieldEnumSchema.array()]).optional() }).strict();