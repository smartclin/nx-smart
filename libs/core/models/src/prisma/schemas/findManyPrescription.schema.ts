...
export const PrescriptionFindManySelectSchema: z.ZodType<Prisma.PrescriptionSelect> = z.object({
...
export const PrescriptionFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    medicalRecordId: z.boolean().optional(),
    doctorId: z.boolean().optional(),
    patientId: z.boolean().optional(),
