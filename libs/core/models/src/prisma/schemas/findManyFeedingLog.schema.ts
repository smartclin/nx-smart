...
export const FeedingLogFindManySelectSchema: z.ZodType<Prisma.FeedingLogSelect> = z.object({
...
export const FeedingLogFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    patientId: z.boolean().optional(),
    patient: z.boolean().optional(),
    date: z.boolean().optional(),
...
export const FeedingLogFindManySchema: z.ZodType<Prisma.FeedingLogFindManyArgs> = z.object({ select: FeedingLogFindManySelectSchema.optional(), include: z.lazy(() => FeedingLogIncludeObjectSchema.optional()), orderBy: z.union([FeedingLogOrderByWithRelationInputObjectSchema, FeedingLogOrderByWithRelationInputObjectSchema.array()]).optional(), where: FeedingLogWhereInputObjectSchema.optional(), cursor: FeedingLogWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([FeedingLogScalarFieldEnumSchema, FeedingLogScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.FeedingLogFindManyArgs>;

export const FeedingLogFindManyZodSchema = z.object({ select: FeedingLogFindManySelectSchema.optional(), include: z.lazy(() => FeedingLogIncludeObjectSchema.optional()), orderBy: z.union([FeedingLogOrderByWithRelationInputObjectSchema, FeedingLogOrderByWithRelationInputObjectSchema.array()]).optional(), where: FeedingLogWhereInputObjectSchema.optional(), cursor: FeedingLogWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([FeedingLogScalarFieldEnumSchema, FeedingLogScalarFieldEnumSchema.array()]).optional() }).strict();