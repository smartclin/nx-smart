...
export const VitalSignsFindFirstSelectSchema: z.ZodType<Prisma.VitalSignsSelect> = z.object({
...
export const VitalSignsFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    encounterId: z.boolean().optional(),
    encounter: z.boolean().optional(),
    patientId: z.boolean().optional(),
...
export const VitalSignsFindFirstSchema: z.ZodType<Prisma.VitalSignsFindFirstArgs> = z.object({ select: VitalSignsFindFirstSelectSchema.optional(), include: z.lazy(() => VitalSignsIncludeObjectSchema.optional()), orderBy: z.union([VitalSignsOrderByWithRelationInputObjectSchema, VitalSignsOrderByWithRelationInputObjectSchema.array()]).optional(), where: VitalSignsWhereInputObjectSchema.optional(), cursor: VitalSignsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([VitalSignsScalarFieldEnumSchema, VitalSignsScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.VitalSignsFindFirstArgs>;

export const VitalSignsFindFirstZodSchema = z.object({ select: VitalSignsFindFirstSelectSchema.optional(), include: z.lazy(() => VitalSignsIncludeObjectSchema.optional()), orderBy: z.union([VitalSignsOrderByWithRelationInputObjectSchema, VitalSignsOrderByWithRelationInputObjectSchema.array()]).optional(), where: VitalSignsWhereInputObjectSchema.optional(), cursor: VitalSignsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([VitalSignsScalarFieldEnumSchema, VitalSignsScalarFieldEnumSchema.array()]).optional() }).strict();