...
export const MedicalRecordsFindFirstSelectSchema: z.ZodType<Prisma.MedicalRecordsSelect> = z.object({
...
export const MedicalRecordsFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    patientId: z.boolean().optional(),
    appointmentId: z.boolean().optional(),
    doctorId: z.boolean().optional(),
