...
export const TwoFactorFindFirstOrThrowSelectSchema: z.ZodType<Prisma.TwoFactorSelect> = z.object({
...
export const TwoFactorFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    secret: z.boolean().optional(),
    backupCodes: z.boolean().optional(),
    userId: z.boolean().optional(),
