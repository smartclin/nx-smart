...
export const WHOGrowthStandardFindFirstSelectSchema: z.ZodType<Prisma.WHOGrowthStandardSelect> = z.object({
...
export const WHOGrowthStandardFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    ageInMonths: z.boolean().optional(),
    gender: z.boolean().optional(),
    measurementType: z.boolean().optional(),
...
export const WHOGrowthStandardFindFirstSchema: z.ZodType<Prisma.WHOGrowthStandardFindFirstArgs> = z.object({ select: WHOGrowthStandardFindFirstSelectSchema.optional(),  orderBy: z.union([WHOGrowthStandardOrderByWithRelationInputObjectSchema, WHOGrowthStandardOrderByWithRelationInputObjectSchema.array()]).optional(), where: WHOGrowthStandardWhereInputObjectSchema.optional(), cursor: WHOGrowthStandardWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([WHOGrowthStandardScalarFieldEnumSchema, WHOGrowthStandardScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.WHOGrowthStandardFindFirstArgs>;

export const WHOGrowthStandardFindFirstZodSchema = z.object({ select: WHOGrowthStandardFindFirstSelectSchema.optional(),  orderBy: z.union([WHOGrowthStandardOrderByWithRelationInputObjectSchema, WHOGrowthStandardOrderByWithRelationInputObjectSchema.array()]).optional(), where: WHOGrowthStandardWhereInputObjectSchema.optional(), cursor: WHOGrowthStandardWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([WHOGrowthStandardScalarFieldEnumSchema, WHOGrowthStandardScalarFieldEnumSchema.array()]).optional() }).strict();