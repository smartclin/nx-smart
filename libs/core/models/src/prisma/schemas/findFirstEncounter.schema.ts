...
export const EncounterFindFirstSelectSchema: z.ZodType<Prisma.EncounterSelect> = z.object({
...
export const EncounterFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    patientId: z.boolean().optional(),
    patient: z.boolean().optional(),
    doctorId: z.boolean().optional(),
...
export const EncounterFindFirstSchema: z.ZodType<Prisma.EncounterFindFirstArgs> = z.object({ select: EncounterFindFirstSelectSchema.optional(), include: z.lazy(() => EncounterIncludeObjectSchema.optional()), orderBy: z.union([EncounterOrderByWithRelationInputObjectSchema, EncounterOrderByWithRelationInputObjectSchema.array()]).optional(), where: EncounterWhereInputObjectSchema.optional(), cursor: EncounterWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([EncounterScalarFieldEnumSchema, EncounterScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.EncounterFindFirstArgs>;

export const EncounterFindFirstZodSchema = z.object({ select: EncounterFindFirstSelectSchema.optional(), include: z.lazy(() => EncounterIncludeObjectSchema.optional()), orderBy: z.union([EncounterOrderByWithRelationInputObjectSchema, EncounterOrderByWithRelationInputObjectSchema.array()]).optional(), where: EncounterWhereInputObjectSchema.optional(), cursor: EncounterWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([EncounterScalarFieldEnumSchema, EncounterScalarFieldEnumSchema.array()]).optional() }).strict();