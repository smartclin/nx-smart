...
import { WorkingDaysDoctorIdDayCompoundUniqueInputObjectSchema as WorkingDaysDoctorIdDayCompoundUniqueInputObjectSchema } from './WorkingDaysDoctorIdDayCompoundUniqueInput.schema'

const makeSchema = () => z.object({
  id: z.number().int().optional(),
  doctorId_day: z.lazy(() => WorkingDaysDoctorIdDayCompoundUniqueInputObjectSchema).optional()
}).strict().superRefine((obj, ctx) => {
        const presentTop = (k: string) => (obj as any)[k] != null;
        const singles: string[] = ["id"] as string[];
        const groups: string[][] = [["doctorId","day"]] as string[][];
...
export const WorkingDaysWhereUniqueInputObjectSchema: z.ZodType<Prisma.WorkingDaysWhereUniqueInput> = makeSchema() as unknown as z.ZodType<Prisma.WorkingDaysWhereUniqueInput>;
export const WorkingDaysWhereUniqueInputObjectZodSchema = makeSchema();
