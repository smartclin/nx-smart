...
const growthchartscalarwhereinputSchema = z.object({
  AND: z.union([z.lazy(() => GrowthChartScalarWhereInputObjectSchema), z.lazy(() => GrowthChartScalarWhereInputObjectSchema).array()]).optional(),
  OR: z.lazy(() => GrowthChartScalarWhereInputObjectSchema).array().optional(),
  NOT: z.union([z.lazy(() => GrowthChartScalarWhereInputObjectSchema), z.lazy(() => GrowthChartScalarWhereInputObjectSchema).array()]).optional(),
...
export const GrowthChartScalarWhereInputObjectSchema: z.ZodType<Prisma.GrowthChartScalarWhereInput> = growthchartscalarwhereinputSchema as unknown as z.ZodType<Prisma.GrowthChartScalarWhereInput>;
export const GrowthChartScalarWhereInputObjectZodSchema = growthchartscalarwhereinputSchema;
