...
import { AppointmentUpdateOneRequiredWithoutRemindersNestedInputObjectSchema as AppointmentUpdateOneRequiredWithoutRemindersNestedInputObjectSchema } from './AppointmentUpdateOneRequiredWithoutRemindersNestedInput.schema'
...
const makeSchema = () => z.object({
  ...
  appointment: z.lazy(() => AppointmentUpdateOneRequiredWithoutRemindersNestedInputObjectSchema).optional()
}).strict();
export const ReminderUpdateInputObjectSchema: z.ZodType<Prisma.ReminderUpdateInput> = makeSchema() as unknown as z.ZodType<Prisma.ReminderUpdateInput>;
export const ReminderUpdateInputObjectZodSchema = makeSchema();
