...
import { PatientUpdateOneRequiredWithoutFeedingLogsNestedInputObjectSchema as PatientUpdateOneRequiredWithoutFeedingLogsNestedInputObjectSchema } from './PatientUpdateOneRequiredWithoutFeedingLogsNestedInput.schema'
...
const makeSchema = () => z.object({
  ...
  patient: z.lazy(() => PatientUpdateOneRequiredWithoutFeedingLogsNestedInputObjectSchema).optional()
}).strict();
export const FeedingLogUpdateInputObjectSchema: z.ZodType<Prisma.FeedingLogUpdateInput> = makeSchema() as unknown as z.ZodType<Prisma.FeedingLogUpdateInput>;
export const FeedingLogUpdateInputObjectZodSchema = makeSchema();
