...
export const PatientBillsCreateNestedManyWithoutPaymentInputObjectSchema: z.ZodType<Prisma.PatientBillsCreateNestedManyWithoutPaymentInput> = makeSchema() as unknown as z.ZodType<Prisma.PatientBillsCreateNestedManyWithoutPaymentInput>;
export const PatientBillsCreateNestedManyWithoutPaymentInputObjectZodSchema = makeSchema();
