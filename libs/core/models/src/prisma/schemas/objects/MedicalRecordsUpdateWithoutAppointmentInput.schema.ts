...
import { PrescriptionUpdateManyWithoutMedicalRecordNestedInputObjectSchema as PrescriptionUpdateManyWithoutMedicalRecordNestedInputObjectSchema } from './PrescriptionUpdateManyWithoutMedicalRecordNestedInput.schema';
...
const makeSchema = () => z.object({
  ...
  prescriptionsList: z.lazy(() => PrescriptionUpdateManyWithoutMedicalRecordNestedInputObjectSchema).optional(),
  vitalSigns: z.lazy(() => VitalSignsUpdateManyWithoutMedicalNestedInputObjectSchema).optional()
}).strict();
export const MedicalRecordsUpdateWithoutAppointmentInputObjectSchema: z.ZodType<Prisma.MedicalRecordsUpdateWithoutAppointmentInput> = makeSchema() as unknown as z.ZodType<Prisma.MedicalRecordsUpdateWithoutAppointmentInput>;
export const MedicalRecordsUpdateWithoutAppointmentInputObjectZodSchema = makeSchema();
