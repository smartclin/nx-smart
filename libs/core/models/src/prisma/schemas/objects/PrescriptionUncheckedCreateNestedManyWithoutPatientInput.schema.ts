...
export const PrescriptionUncheckedCreateNestedManyWithoutPatientInputObjectSchema: z.ZodType<Prisma.PrescriptionUncheckedCreateNestedManyWithoutPatientInput> = makeSchema() as unknown as z.ZodType<Prisma.PrescriptionUncheckedCreateNestedManyWithoutPatientInput>;
export const PrescriptionUncheckedCreateNestedManyWithoutPatientInputObjectZodSchema = makeSchema();
