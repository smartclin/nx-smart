...
export const PaymentUncheckedCreateNestedManyWithoutAppointmentInputObjectSchema: z.ZodType<Prisma.PaymentUncheckedCreateNestedManyWithoutAppointmentInput> = makeSchema() as unknown as z.ZodType<Prisma.PaymentUncheckedCreateNestedManyWithoutAppointmentInput>;
export const PaymentUncheckedCreateNestedManyWithoutAppointmentInputObjectZodSchema = makeSchema();
