...
export const EncounterUncheckedCreateNestedManyWithoutDoctorInputObjectSchema: z.ZodType<Prisma.EncounterUncheckedCreateNestedManyWithoutDoctorInput> = makeSchema() as unknown as z.ZodType<Prisma.EncounterUncheckedCreateNestedManyWithoutDoctorInput>;
export const EncounterUncheckedCreateNestedManyWithoutDoctorInputObjectZodSchema = makeSchema();
