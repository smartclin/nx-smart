...
const makeSchema = () => z.object({
  ...
  immunizations: z.lazy(() => ImmunizationUncheckedCreateNestedManyWithoutAdministeredByInputObjectSchema),
  GrowthChart: z.lazy(() => GrowthChartUncheckedCreateNestedManyWithoutMeasuredByInputObjectSchema)
}).strict();
