...
const makeSchema = () => z.object({
  ...
  labTests: z.lazy(() => LabTestCreateNestedManyWithoutMedicalRecordInputObjectSchema),
  encounters: z.lazy(() => EncounterCreateNestedManyWithoutMedicalInputObjectSchema),
  diagnoses: z.lazy(() => DiagnosisCreateNestedManyWithoutMedicalInputObjectSchema),
  prescriptionsList: z.lazy(() => PrescriptionCreateNestedManyWithoutMedicalRecordInputObjectSchema),
  vitalSigns: z.lazy(() => VitalSignsCreateNestedManyWithoutMedicalInputObjectSchema)
}).strict();
export const MedicalRecordsCreateInputObjectSchema: z.ZodType<Prisma.MedicalRecordsCreateInput> = makeSchema() as unknown as z.ZodType<Prisma.MedicalRecordsCreateInput>;
export const MedicalRecordsCreateInputObjectZodSchema = makeSchema();
