...
export const GrowthChartMaxAggregateInputObjectSchema: z.ZodType<Prisma.GrowthChartMaxAggregateInputType> = makeSchema() as unknown as z.ZodType<Prisma.GrowthChartMaxAggregateInputType>;
export const GrowthChartMaxAggregateInputObjectZodSchema = makeSchema();
