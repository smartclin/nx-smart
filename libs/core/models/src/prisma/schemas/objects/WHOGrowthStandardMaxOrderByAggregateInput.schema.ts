...
export const WHOGrowthStandardMaxOrderByAggregateInputObjectSchema: z.ZodType<Prisma.WHOGrowthStandardMaxOrderByAggregateInput> = makeSchema() as unknown as z.ZodType<Prisma.WHOGrowthStandardMaxOrderByAggregateInput>;
export const WHOGrowthStandardMaxOrderByAggregateInputObjectZodSchema = makeSchema();
