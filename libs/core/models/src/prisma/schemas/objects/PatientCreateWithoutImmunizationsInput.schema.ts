...
const makeSchema = () => z.object({
  ...
  medical: z.lazy(() => MedicalRecordsCreateNestedManyWithoutPatientInputObjectSchema).optional(),
  payments: z.lazy(() => PaymentCreateNestedManyWithoutPatientInputObjectSchema).optional(),
  encounters: z.lazy(() => EncounterCreateNestedManyWithoutPatientInputObjectSchema).optional(),
  growthCharts: z.lazy(() => GrowthChartCreateNestedManyWithoutPatientInputObjectSchema).optional(),
  feedingLogs: z.lazy(() => FeedingLogCreateNestedManyWithoutPatientInputObjectSchema).optional(),
  billing: z.lazy(() => BillingCreateNestedManyWithoutPatientInputObjectSchema).optional(),
  prescriptions: z.lazy(() => PrescriptionCreateNestedManyWithoutPatientInputObjectSchema).optional()
}).strict();
export const PatientCreateWithoutImmunizationsInputObjectSchema: z.ZodType<Prisma.PatientCreateWithoutImmunizationsInput> = makeSchema() as unknown as z.ZodType<Prisma.PatientCreateWithoutImmunizationsInput>;
export const PatientCreateWithoutImmunizationsInputObjectZodSchema = makeSchema();
