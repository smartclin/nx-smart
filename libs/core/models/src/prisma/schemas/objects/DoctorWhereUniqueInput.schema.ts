...
const makeSchema = () => z.object({
  ...
  userId: z.string().optional()
        ...
        const singles: string[] = ["id","email","userId"] as string[];
...
export const DoctorWhereUniqueInputObjectSchema: z.ZodType<Prisma.DoctorWhereUniqueInput> = makeSchema() as unknown as z.ZodType<Prisma.DoctorWhereUniqueInput>;
export const DoctorWhereUniqueInputObjectZodSchema = makeSchema();
