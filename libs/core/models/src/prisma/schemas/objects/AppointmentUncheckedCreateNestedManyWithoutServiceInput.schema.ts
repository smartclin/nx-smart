...
export const AppointmentUncheckedCreateNestedManyWithoutServiceInputObjectSchema: z.ZodType<Prisma.AppointmentUncheckedCreateNestedManyWithoutServiceInput> = makeSchema() as unknown as z.ZodType<Prisma.AppointmentUncheckedCreateNestedManyWithoutServiceInput>;
export const AppointmentUncheckedCreateNestedManyWithoutServiceInputObjectZodSchema = makeSchema();
