...
import { FileUpdateOneWithoutAdminsNestedInputObjectSchema as FileUpdateOneWithoutAdminsNestedInputObjectSchema } from './FileUpdateOneWithoutAdminsNestedInput.schema'
...
const makeSchema = () => z.object({
  ...
  avatar: z.lazy(() => FileUpdateOneWithoutAdminsNestedInputObjectSchema).optional()
}).strict();
export const AdminUpdateWithoutUploadsInputObjectSchema: z.ZodType<Prisma.AdminUpdateWithoutUploadsInput> = makeSchema() as unknown as z.ZodType<Prisma.AdminUpdateWithoutUploadsInput>;
export const AdminUpdateWithoutUploadsInputObjectZodSchema = makeSchema();
