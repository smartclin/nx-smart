...
export const ServicesFindFirstOrThrowSelectSchema: z.ZodType<Prisma.ServicesSelect> = z.object({
...
export const ServicesFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    serviceName: z.boolean().optional(),
    description: z.boolean().optional(),
    price: z.boolean().optional(),
...
export const ServicesFindFirstOrThrowSchema: z.ZodType<Prisma.ServicesFindFirstOrThrowArgs> = z.object({ select: ServicesFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => ServicesIncludeObjectSchema.optional()), orderBy: z.union([ServicesOrderByWithRelationInputObjectSchema, ServicesOrderByWithRelationInputObjectSchema.array()]).optional(), where: ServicesWhereInputObjectSchema.optional(), cursor: ServicesWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ServicesScalarFieldEnumSchema, ServicesScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ServicesFindFirstOrThrowArgs>;

export const ServicesFindFirstOrThrowZodSchema = z.object({ select: ServicesFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => ServicesIncludeObjectSchema.optional()), orderBy: z.union([ServicesOrderByWithRelationInputObjectSchema, ServicesOrderByWithRelationInputObjectSchema.array()]).optional(), where: ServicesWhereInputObjectSchema.optional(), cursor: ServicesWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ServicesScalarFieldEnumSchema, ServicesScalarFieldEnumSchema.array()]).optional() }).strict();