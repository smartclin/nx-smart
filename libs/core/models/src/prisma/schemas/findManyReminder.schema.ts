...
export const ReminderFindManySelectSchema: z.ZodType<Prisma.ReminderSelect> = z.object({
...
export const ReminderFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    appointmentId: z.boolean().optional(),
    appointment: z.boolean().optional(),
    method: z.boolean().optional(),
