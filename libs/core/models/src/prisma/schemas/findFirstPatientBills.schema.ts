...
export const PatientBillsFindFirstSelectSchema: z.ZodType<Prisma.PatientBillsSelect> = z.object({
...
export const PatientBillsFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    billId: z.boolean().optional(),
    serviceId: z.boolean().optional(),
    serviceDate: z.boolean().optional(),
...
export const PatientBillsFindFirstSchema: z.ZodType<Prisma.PatientBillsFindFirstArgs> = z.object({ select: PatientBillsFindFirstSelectSchema.optional(), include: z.lazy(() => PatientBillsIncludeObjectSchema.optional()), orderBy: z.union([PatientBillsOrderByWithRelationInputObjectSchema, PatientBillsOrderByWithRelationInputObjectSchema.array()]).optional(), where: PatientBillsWhereInputObjectSchema.optional(), cursor: PatientBillsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PatientBillsScalarFieldEnumSchema, PatientBillsScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.PatientBillsFindFirstArgs>;

export const PatientBillsFindFirstZodSchema = z.object({ select: PatientBillsFindFirstSelectSchema.optional(), include: z.lazy(() => PatientBillsIncludeObjectSchema.optional()), orderBy: z.union([PatientBillsOrderByWithRelationInputObjectSchema, PatientBillsOrderByWithRelationInputObjectSchema.array()]).optional(), where: PatientBillsWhereInputObjectSchema.optional(), cursor: PatientBillsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PatientBillsScalarFieldEnumSchema, PatientBillsScalarFieldEnumSchema.array()]).optional() }).strict();